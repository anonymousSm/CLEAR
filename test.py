...
parser.add_argument('-base', default=100, type=int, help='task')
...
for task_id in range(num_task):
    ...
    # print("train class set in task " + str(task_id) + " is: ")
    # print(set(np.array(train_labels_cl)))
    ...
    # print("class set in task " + str(task_id) + " is: ")
    # print(set(class_label))
    ...
    if task_id > 0 and args.mapping_test:
        ...
        # np.savetxt("train_labels_" + str(task_id) + ".txt", train_labels_cl_old, fmt="%s")
        # output embedding
        # if task_id < 6:
        #     X1 = np.array(train_embeddings_cl_old)
        #     Y1 = np.array(train_labels_cl_old)
        #     Y1 = label_mapping(Y1)
        #     embedding1 = TSNE(n_jobs=4).fit_transform(X1)
        #     # embedding2 = TSNE(n_jobs=4).fit_transform(X2)
        #     vis_x1 = embedding1[:, 0]
        #     vis_y1 = embedding1[:, 1]
        #
        #     plt.scatter(vis_x1, vis_y1, c=Y1, cmap=plt.cm.get_cmap("jet", 20), marker='.')
        #     plt.clim(-0.5, 9.5)
        #     name = 'EWC_embedding_' + str(task_id) + '.jpg'
        #     plt.savefig('results/flower' + name)
